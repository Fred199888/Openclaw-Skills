...
def main():
    ...
    ap.add_argument("--app-token", default=os.getenv("XINGTU_KOL_APP_TOKEN", APP_TOKEN))
    ap.add_argument("--table-id", default=os.getenv("XINGTU_KOL_TABLE_ID", TABLE_ID))
