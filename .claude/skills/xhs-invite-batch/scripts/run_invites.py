...
def main():
    ...
    ap.add_argument("--global-env", default=os.getenv("XHS_GLOBAL_ENV", str(Path.home()/".claude/skills/xhs-global.env")))
    ...
    tk = req("POST", "https://open.feishu.cn/open-apis/auth/v3/tenant_access_token/internal", data={"app_id": app_id, "app_secret": app_secret})["tenant_access_token"]
